...
@section('content')
    ...
    <section class="hero-bg text-white pt-32 pb-24 md:pt-40 md:pb-32 relative overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="{{ asset('img/XXXL.webp') }}" alt="Фон ремонта гидротрансформаторов" class="w-full h-full object-cover object-center" loading="lazy">
        </div>
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-5xl mx-auto text-center">
                ...
                <div class="flex flex-col md:flex-row gap-6 md:gap-8 justify-center items-center">
                    <a href="https://yandex.by/maps/org/gidrotransformator/193710186009" target="_blank" class="bg-secondary-500 hover:bg-secondary-600 text-white font-black text-base md:text-lg lg:text-xl px-6 md:px-10 lg:px-12 py-3 md:py-4 lg:py-5 rounded-xl md:rounded-2xl shadow-lg transition-colors duration-200 flex items-center">
                    ...
                    <button onclick="openCallback()" class="bg-white/20 border border-white/30 text-white font-black text-base md:text-lg lg:text-xl px-6 md:px-10 lg:px-12 py-3 md:py-4 lg:py-5 rounded-xl md:rounded-2xl shadow-lg hover:bg-white/30 transition-colors duration-200">
                        Заказать звонок
                    </button>
                </div>
            </div>
        ...
        <div class="container mx-auto px-6">
            <div class="max-w-4xl 2xl:max-w-6xl mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
                    <!-- Адрес -->
                    <div class="relative bg-gradient-to-br from-primary-700 to-primary-800 text-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-lg">
                        <div>
                            ...
                            <div class="mt-8">
                                <a href="https://yandex.by/maps/org/gidrotransformator/193710186009"
                                   ...
                                   class="w-full bg-accent-500 hover:bg-accent-600 text-white font-bold text-base md:text-lg py-3 md:py-4 rounded-lg md:rounded-xl shadow-lg transition-colors duration-200 flex items-center justify-center">
                    ...
                    <!-- Телефоны -->
                    <div class="relative bg-gradient-to-br from-secondary-500 to-secondary-600 text-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-lg">
                        <div>
                            <div class="bg-white/20 w-16 h-16 md:w-20 md:h-20 rounded-xl md:rounded-2xl flex items-center justify-center mb-6 mx-auto">
                            ...
                            <div class="mt-8">
                                <button onclick="openCallback()"
                                        class="w-full bg-white text-secondary-600 hover:bg-gray-100 font-bold text-base md:text-lg py-3 md:py-4 rounded-lg md:rounded-xl shadow-lg transition-colors duration-200">
                    ...
                    <!-- График работы -->
                    <div class="relative bg-gradient-to-br from-gray-800 to-gray-900 text-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-lg">
                        <div>
                            <div class="bg-white/20 w-16 h-16 md:w-20 md:h-20 rounded-xl md:rounded-2xl flex items-center justify-center mb-6 mx-auto">
            ...
            <div class="max-w-4xl 2xl:max-w-6xl mx-auto">
                ...
                <div class="bg-white rounded-2xl md:rounded-3xl shadow-lg overflow-hidden">
                    ...
                    <div class="h-96 md:h-[500px] relative">
                        ...
                        <div class="absolute top-4 left-4 bg-white/95 border border-gray-200 rounded-lg p-4 shadow-lg max-w-xs">
    ...
    <section class="hero-bg text-white py-16 md:py-24 relative overflow-hidden">
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="flex flex-col md:flex-row gap-6 md:gap-8 justify-center">
                <a href="tel:+375447348543" class="bg-secondary-500 hover:bg-secondary-600 text-white font-black text-base md:text-lg lg:text-xl px-6 md:px-10 lg:px-14 py-3 md:py-4 lg:py-5 rounded-xl md:rounded-2xl lg:rounded-3xl shadow-lg transition-colors duration-200 flex items-center justify-center">
                    <svg class="w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                    +375 (44) 734-85-43
                </a>
                <a href="https://yandex.by/maps/157/minsk/?ll=27.656621%2C53.870665&mode=routes&rtext=~53.870665%2C27.656621&rtt=mt&ruri=~ymapsbm1%3A%2F%2Forg%3Foid%3D193710186009&z=14"
                   target="_blank"
                   rel="noopener noreferrer"
                   class="bg-white/20 border border-white/30 text-white font-black text-base md:text-lg lg:text-xl px-6 md:px-10 lg:px-14 py-3 md:py-4 lg:py-5 rounded-xl md:rounded-2xl lg:rounded-3xl hover:bg-white/30 transition-colors duration-200 flex items-center justify-center">
                    <svg class="w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    Проложить маршрут
                </a>
            </div>
