        ...
        <div class="container mx-auto px-6">
            ...
            <div class="max-w-4xl lg:max-w-6xl mx-auto">
                <p class="text-lg md:text-xl text-gray-700 mb-6 md:mb-8 leading-relaxed">
                    ЧТУП «Гидротрансформатор» — первая специализированная компания в Беларуси, занимающаяся исключительно <strong>ремонтом гидротрансформаторов (ГДТ) АКПП</strong>. За 20 лет работы мы восстановили более 20 000 гидротрансформаторов для автомобилей всех марок.
                </p>
