    ...
    <div class="container mx-auto px-6 py-4">
        <nav class="flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center space-x-10">
                ...
                <a href="tel:+375447348543" class="hidden xl:block bg-secondary-500 hover:bg-secondary-600 text-white px-8 py-3 rounded-full font-bold shadow-xl hover:shadow-2xl transition transform hover:scale-105">+375 (44) 734-85-43</a>
            </div>
...
<!-- Mobile Menu -->
<div id="mobile-menu"
     class="fixed inset-0 bg-white z-40 hidden opacity-0 transition-all duration-300 ease-in-out"
     aria-hidden="true"
     role="dialog"
     aria-modal="true"
    ...
    <div class="h-full flex items-center justify-center">
        <div class="text-center space-y-8 px-6">
            ...
            <a href="tel:+375447348543" class="block text-3xl font-bold text-secondary-500 hover:text-secondary-600 transition">+375 (44) 734-85-43</a>
...
<script>
    ...
    function openMobileMenu() {
        ...
        // Убираем hidden и плавно показываем
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        console.log('  mobile-btn:', !!document.getElementById('mobile-btn'));
        console.log('  mobile-close:', !!document.getElementById('mobile-close'));
        ...
        setTimeout(() => {
            const testBtn = document.getElementById('mobile-btn');
            if (testBtn) {
                testBtn.addEventListener('click', function() {
                    console.log('✅ Кнопка бургера работает!');
                });
            }
        }, 1000);
    });
